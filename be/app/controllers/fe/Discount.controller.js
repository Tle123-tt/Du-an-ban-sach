...
const DataService = require( "../../services/discount.service" );
...
exports.showByCode = async ( req, res ) =>
{
	try
	{
		const response =  await DataService.showByCode( req.params.slug, req.query );
		await buildResponse(res, response);
	} catch ( e )
	{
		buildResponseException( res, 400, {
